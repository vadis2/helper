````
  php artisan make:command         Create a new command class
  php artisan make:console         Create a new Artisan command
  php artisan make:controller controller_name     Create a new resource controller class
